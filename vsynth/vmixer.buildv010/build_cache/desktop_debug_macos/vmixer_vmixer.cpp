...
void g_default_VSynth_audio_0callback(void* l_a,bbUByte* l_b,bbInt l_byteCount){
  ...
  bbDBFrame db_f{"audio_callback:Void(a:Void Ptr,b:Ubyte Ptr,byteCount:Int)","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
  bbDBLocal("a",&l_a);
  bbDBLocal("b",&l_b);
...
void bbMain(){
  ...
  bbDBFrame db_f{"Main:Void()","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
  bbDBStmt(397313);
...
t_default_VSynth::t_default_VSynth(bbString l_title):t_mojo_app_Window(l_title,720,560,8){
  bbDBFrame db_f{"new:Void(title:String)","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
...
void t_default_VSynth::m_OpenAudio(){
  ...
  bbDBFrame db_f{"OpenAudio:Void()","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
...
void t_default_VSynth::m_OnMouseEvent(t_mojo_app_MouseEvent* l_event){
  bbDBFrame db_f{"OnMouseEvent:Void(event:mojo.app.MouseEvent)","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
  t_default_VSynth*self=this;
  bbDBLocal("Self",&self);
...
void t_default_VSynth::m_OnKeyEvent(t_mojo_app_KeyEvent* l_event){
  bbDBFrame db_f{"OnKeyEvent:Void(event:mojo.app.KeyEvent)","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
  t_default_VSynth*self=this;
  bbDBLocal("Self",&self);
  bbDBLocal("event",&l_event);
...
bbArray<bbFloat>* t_default_VSynth::m_FillAudioBuffer(bbInt l_samples){
  bbDBFrame db_f{"FillAudioBuffer:Float[](samples:Int)","/Users/simon/nitrologic/m2/vmixer/vmixer.monkey2"};
  t_default_VSynth*self=this;
  bbDBLocal("Self",&self);
  bbDBLocal("samples",&l_samples);
  bbDBStmt(188424);
