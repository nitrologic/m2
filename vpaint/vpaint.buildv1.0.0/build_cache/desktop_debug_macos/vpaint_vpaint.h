...
#include "../../../../../../monkey2/modules/mojo/mojo.buildv1.0.0/desktop_debug_macos/mojo_graphics_2image.h"
...
#include "../../../../../../monkey2/modules/std/std.buildv1.0.0/desktop_debug_macos/std_graphics_2color.h"
...
extern t_std_graphics_Color g_default_VPaint_Transparent;
...
bbString bbDBValue(t_default_VPane**);
...
bbString bbDBValue(t_default_VBrowse**);
...
bbString bbDBValue(t_default_VToolbar**);
...
struct t_default_VPaint : public t_mojo_app_Window{
  ...
  bbInt m_statusCount{};
  bbGCVar<bbArray<bbInt>> m_control{};
  ...
  void m_OnControl(bbInt l_index,bbInt l_value);
  void m_InitMidi();
  void m_Hold();
  void m_DrawMode();
...
bbString bbDBValue(t_default_VPaint**);
